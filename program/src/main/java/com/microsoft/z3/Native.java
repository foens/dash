...
public final class Native {
  ...
  public static native void setInternalErrorHandler(long ctx);
    ...
    static {
        ...
        if(System.getProperty("dk.au.cs.dash.debug") == null) {
            System.loadLibrary("MSVCR110");
        } else {
            System.loadLibrary("MSVCR110d");
            System.loadLibrary("vcomp110d");
  ...
  protected static native long INTERNALmkInterp(long a0, long a1);
  ...
  public static long mkInterp(long a0, long a1) throws Z3Exception
  {
      long res = INTERNALmkInterp(a0, a1);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsgEx(a0, err.toInt()));
      return res;
